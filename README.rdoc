...
== This version of rash has been renamed snake_case_hash gem (with class Hashie::SCHash) to avoid namespace conflicts in gem dependencies.
...
* Zac Colon (https://github.com/wzcolon) for initially moving Rash to a new namespace.
